...
# 注意事項
・二次配布を禁止します。また、このデータパックを改変することは可能ですが、オリジナルのものとして公開するのを控えてください。普通に二次創作として配布していただく分には申し分ございません。また、個人で改造していろんな楽しみ方をしてくれる分にはウェルカムです(クリエイティブコモンズもあるのでその辺も参考に)  
